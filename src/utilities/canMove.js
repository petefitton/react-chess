function canMove(pieceType, sourceTile, targetTile) {
  if (/^[P]+$/.test(pieceType)) {
    // piece is a white Pawn
    // determine if Pawn can move from source location to target location
// TODO: write logic for if a white pawn can make a specific move
    return true;
  }
